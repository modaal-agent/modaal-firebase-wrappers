...
//
// Swift-idiomatic `mergeOption: MergeOption` form for batch `setData`,
// dispatching to the canonical `setData(_:forDocument:merge:)` /
// `setData(_:forDocument:mergeFields:)` protocol methods.
