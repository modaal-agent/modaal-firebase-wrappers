...
class CloudCollectionStoringMock: CloudCollectionStoring {
    ...
    // MARK: - Methods
    func listAll(completion: (Result<CloudStorageListResultProtocol, Error>) -> Void) {
        listAllCallCount += 1
    ...
    var listAllHandler: ((_ completion: (Result<CloudStorageListResultProtocol, Error>) -> Void) -> ())? = nil
}
...
class CloudFileStoringMock: CloudFileStoring {
    ...
    func downloadToFile(localURL: URL, completion: (Result<URL, Error>) -> Void) {
    ...
    var downloadToFileHandler: ((_ localURL: URL, _ completion: (Result<URL, Error>) -> Void) -> ())? = nil
    func getData(maxSize: Int64, completion: (Result<Data, Error>) -> Void) {
        getDataCallCount += 1
    ...
    var getDataHandler: ((_ maxSize: Int64, _ completion: (Result<Data, Error>) -> Void) -> ())? = nil
    func getDownloadURL(completion: (Result<URL, Error>) -> Void) {
    ...
    var getDownloadURLHandler: ((_ completion: (Result<URL, Error>) -> Void) -> ())? = nil
    func getMetadata(completion: (Result<CloudStorageMetadata, Error>) -> Void) {
    ...
    var getMetadataHandler: ((_ completion: (Result<CloudStorageMetadata, Error>) -> Void) -> ())? = nil
    func putData(_ data: Data, completion: (Result<Void, Error>) -> Void) {
        putDataCallCount += 1
    ...
    var putDataHandler: ((_ data: Data, _ completion: (Result<Void, Error>) -> Void) -> ())? = nil
    func putData(_ data: Data, metadata: CloudStorageMetadata, completion: (Result<Void, Error>) -> Void) {
    ...
    var putDataDataMetadataCompletionHandler: ((_ data: Data, _ metadata: CloudStorageMetadata, _ completion: (Result<Void, Error>) -> Void) -> ())? = nil
    func updateMetadata(_ metadata: CloudStorageMetadata, completion: (Result<CloudStorageMetadata, Error>) -> Void) {
    ...
    var updateMetadataHandler: ((_ metadata: CloudStorageMetadata, _ completion: (Result<CloudStorageMetadata, Error>) -> Void) -> ())? = nil
    func uploadFromFile(localURL: URL, completion: (Result<Void, Error>) -> Void) {
    ...
    var uploadFromFileHandler: ((_ localURL: URL, _ completion: (Result<Void, Error>) -> Void) -> ())? = nil
    func uploadFromFile(localURL: URL, metadata: CloudStorageMetadata, completion: (Result<Void, Error>) -> Void) {
    ...
    var uploadFromFileLocalURLMetadataCompletionHandler: ((_ localURL: URL, _ metadata: CloudStorageMetadata, _ completion: (Result<Void, Error>) -> Void) -> ())? = nil
}
